...
while materials and magic_levels:
    material = materials.pop() if magic_levels[0] or not materials[-1] else 0  # проверка дали само едното е 0-> ако имаме магия, но нямаме материали
    magic_level = magic_levels.popleft() if material or not magic_levels[0] else 0  # ако имаме материали, но нямаме магия
